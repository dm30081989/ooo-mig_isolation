...
# mend, izm, novomsk, nlmk
coord_x = [37.1881, 37.8412, 38.2401, 39.6079,
           ]
coord_y = [56.0208, 55.7829, 54.0934, 52.5543,
           ]
height = [24.7, 24.7, 41, 24.7, 
          ]
napr = [110, 110, 220, 110, 
        ]
i_a = [27, 3, 68, 0, 
       ]
i_b = [27, 3, 39, 0, 
...
year = [1987, 2019, 1977, 2020,
        ]

for lat, lon in zip(coord_y, coord_x):
    print('_____________')
    ...
    data_industrial, data_chimney = improver.clarify_location(data_industrial, data_chimney)
    improver.road_accounting(data_road, lat, lon, 200, 500, 1000)
    improver.city_accounting(lat, lon, 5000, data_city, data_road, data_industrial)
...
d = gdata.explore()
d.save("wind_roses_map.html")
>>>>>>> e203ac88c6f0fd5ae41105d4342cc884b65e7085
